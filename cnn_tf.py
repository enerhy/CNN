...
def init_filter(shape, poolsz):
    #The * unpacks a tuple into multiple input arguments. The code is creating
    #a random matrix the same shape as H1 using the shape attribute 
    #(which is a tuple) as the dimension inputs to np.random.rand
